...
public class AddClerkInterface extends JDialog  {
	...
	public AddClerkInterface(TechnicianInterfaces techFrame) {
		...
		JLabel defaultLabel = new JLabel("Enter the following details for the new clerk:");
			...
			public void actionPerformed(ActionEvent e) {
				if(firstNameField.getText().equalsIgnoreCase("") && lastNameField.getText().equalsIgnoreCase("")) {
					...
					JOptionPane.showMessageDialog(null, "Please don't leave the Last Name field blank!","Error",JOptionPane.ERROR_MESSAGE);
						...
						Clerk newClerk;
						try {
							newClerk = techFrame.loginTechnician.createClerk(techFrame.clerks, fname, lname,techFrame.loginTechnician.getEmpId());
