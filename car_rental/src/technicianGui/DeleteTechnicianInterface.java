...
public class DeleteTechnicianInterface extends JDialog {
	...
	private JLabel IdLabel;
	 ...
	 //Create the dialog.
	public DeleteTechnicianInterface(TechnicianInterfaces techFrame) {
		super(techFrame, "Remove a Technician",true);
		...
		JLabel defaultLabel = new JLabel("Search the technician you want to delete");
				...
				if(firstNameField.getText().equalsIgnoreCase("") && lastNameField.getText().equalsIgnoreCase("")) {
					...
					JOptionPane.showMessageDialog(null, "Please don't leave the Last Name field blank!","Error",JOptionPane.ERROR_MESSAGE);
						...
						if(check!=0) {
							...
							resultLabel.setText("Technician Exist");
							resultLabel.setForeground(Color.ORANGE);
							removeButton.setVisible(true);
						}
						else {
							IdLabel.setText("");
							resultLabel.setText("Technician doesn't found!");
		...
		removeButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(value==JOptionPane.YES_OPTION) {
					String fname = firstNameField.getText();
					String lname = lastNameField.getText();
					boolean check = techFrame.loginTechnician.deleteTechnician(techFrame.technicians, fname, lname);
