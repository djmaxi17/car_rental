...
public class SettleRentGui extends JFrame {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (rowSelected != -1) {
					...
					if (confirm == 0) {
						...
						String dateRented = availabilityTable.getModel().getValueAt(rowSelected, 3).toString();
	...
	// function to display pending rents
	private void listPendingRent() {

		rents = connect.BindTableRent(0, 1);
		//create array list 
		//loop through array list 
		String columnName[] = {
			"Id", "Customer", "Car", "Date Rented", "Date due", "Rent Cost"
		};
